...
export default function NotFound({
	...
	return (
		<div className='relative text-center z-[1] pt-52'>
			<div className='-z-10 absolute left-1/2 top-14 md:top-20 transform -translate-x-1/2 w-96 md:w-4xl text-blue-400/40'>
				<Illustration />
			</div>
			<h1 className='mt-4 text-balance text-5xl font-semibold tracking-tight sm:text-7xl text-black'>{title}</h1>
