...
export default function BoardPage() {
	...
	if (loadingState.board) {
		return (
			// <div className='absolute top-1/2 left-1/2 w-12 h-12 border-4 border-t-blue-400 border-b-blue-400 border-l-transparent border-r-transparent rounded-full animate-spin'></div>
			null
		);
	}
